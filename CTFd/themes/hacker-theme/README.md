...
A dark, hacker-inspired clone of `pixo-v2` with a blue-cyan neon palette, low-contrast surfaces, and refined form/button styling for fast CTF workflow.

This theme customizes backgrounds, text, card surfaces, tables, inputs, and code editor cursors for a cyberpunk hacker UI.
